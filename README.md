...
**QuickCart** is a small e-commerce company.  
Every day, order data arrives as CSV files. The data engineering team needs to:
...
| 5    | DELETE                         | Remove records permanently                       |
